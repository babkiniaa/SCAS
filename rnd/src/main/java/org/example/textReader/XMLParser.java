...
public class XMLParser {
    ...
    static String parseSpotBugs(String path) throws XMLStreamException, IOException {
...
//            System.out.println(nextEvent);
            if (nextEvent.isStartElement()) {
                ...
                switch (startElement.getName().getLocalPart()) {
                    ...
                    case "SourceLine":
                        ...
                        report += "\nBug from file: " + srcF.substring(srcF.indexOf('=') + 1, srcF.length());
                        String srcC = startElement.getAttributeByName(new QName("classname")).toString();
                        report += "\nBug from class: " + srcC.substring(srcC.indexOf('=') + 1, srcC.length());
                        String srcD = startElement.getAttributeByName(new QName("sourcepath")).toString();
                        report += "\nWith path: " + srcD.substring(srcD.indexOf('=') + 1, srcD.length());
                }
            }
    ...
    static String parsePMD(String path) throws XMLStreamException, IOException {
        XMLInputFactory xmlInputFactory = XMLInputFactory.newInstance();
        XMLEventReader reader = xmlInputFactory.createXMLEventReader(new FileInputStream(path));
        String report = "";
        while (reader.hasNext()) {
                ...
                switch (startElement.getName().getLocalPart()) {
                    ...
                    case "violation":
                        if (startElement.getAttributeByName(new QName("beginline")) != null){
                            ...
                            report += "\nBegining in line: " + begLine.substring(begLine.indexOf('=') + 1, begLine.length());
                        }
                        if (startElement.getAttributeByName(new QName("begincolumn")) != null){
                            ...
                            report += "\nBegining in column: " + begCol.substring(begCol.indexOf('=') + 1, begCol.length());
                        }
                        if (startElement.getAttributeByName(new QName("endline")) != null){
                            ...
                            report += "\nEnding in line: " + endLine.substring(endLine.indexOf('=') + 1, endLine.length());
                        }
                        if (startElement.getAttributeByName(new QName("endcolumn")) != null){
                            ...
                            report += "\nEnding in column: " + endCol.substring(endCol.indexOf('=') + 1, endCol.length());
                        }
                        if (startElement.getAttributeByName(new QName("rule")) != null){
                            ...
                            report += "\nRule is " + rule.substring(rule.indexOf('=') + 1, rule.length());
                        }
                        if (startElement.getAttributeByName(new QName("ruleset")) != null){
                            ...
                            report += "\nFrom ruleset: " + ruleset.substring(ruleset.indexOf('=') + 1, ruleset.length());
                        }
                        if (startElement.getAttributeByName(new QName("class")) != null){
                            ...
                            report += "\nFor class: " + clas.substring(clas.indexOf('=') + 1, clas.length());
                        }
                        if (startElement.getAttributeByName(new QName("package")) != null){
                            ...
                            report += "\nFrom package: " + pack.substring(pack.indexOf('=') + 1, pack.length());
                        }
                        if (startElement.getAttributeByName(new QName("method")) != null){
                            ...
                            report += "\nFor method: " + meth.substring(meth.indexOf('=') + 1, meth.length());
                        }
                        if (startElement.getAttributeByName(new QName("variable")) != null){
                            ...
                            report += "\nFor variable: " + var.substring(var.indexOf('=') + 1, var.length());
                        }
                        if (startElement.getAttributeByName(new QName("priority")) != null){
                            ...
                            report += "\nWith prior: " + prior.substring(prior.indexOf('=') + 1, prior.length());
                        }
                }
            }
            if (nextEvent.isEndElement()) {
