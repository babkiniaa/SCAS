<template>
  <q-layout view="lHh lpr lFf">
    <q-page :class="isDarkMode ? 'bg-dark' : 'bg-grey-2'">
      ...
      <q-card :class="['q-pa-md', 'shadow-2', isDarkMode ? 'bg-grey-8 text-white' : '']" bordered style="max-width: 400px;">
        <q-card-section class="text-center">
          <div :class="isDarkMode ? 'text-white' : 'text-grey-9'">Reset Password</div>
          <div :class="isDarkMode ? 'text-grey-5' : 'text-grey-8'">A 6-digit code has been sent to your email for password reset</div>
        </q-card-section>
        <q-card-section>
